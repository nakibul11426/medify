...
fun RegistrationScreen(modifier: Modifier = Modifier, navController: NavController) {
    Box(
        ...
        Image(
            painter = painterResource(id = R.drawable.registration_screen_bg),
            contentDescription = "",
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.create_an_account_text),
                style = TextStyle(
                    fontSize = 40.sp,
            ...
            Text(
                text = stringResource(R.string.create_an_account_it_takes_less_than_a_minute_enter_your_email_and_password_text),
                style = TextStyle(
                    fontSize = 16.sp,
            ...
            CustomRoundedButton(
                ...
                buttonText = stringResource(R.string.create_an_account_text)
            )
